...
#ifdef FIX_CLASS
// clang-format off
FixStyle(pimreg/cg/lr,FixPIMRegCGLR);
// clang-format on
#else

#ifndef LMP_FIX_PIMREGCGLR_H
#define LMP_FIX_PIMREGCGLR_H

#include "fix.h"

namespace LAMMPS_NS {

class FixPIMRegCGLR : public Fix {
 public:
  FixPIMRegCGLR(class LAMMPS *, int, char **);
  ~FixPIMRegCGLR() override;
